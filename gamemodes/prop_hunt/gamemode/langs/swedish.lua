...
LANG["PHXM_TAB_MODEL_DISABLED"]	= "Bläddra Modeller (Avstängd)"
...
LANG["PHXM_PLAYER_SEE_LBALL_ICONS"]		= "Aktivera 'Lyckoboll' ikon för visning när de väl upplivas"
...
LANG["PHXM_ADMIN_FORCELANG"] 				= "Använd specifikt språk? Detta överstyr klientspråket till att använda serverns valda språk." -- Fix me
...
LANG["PHXM_ADMIN_NOTICE_ROTATION"]			= "Visa 'Föremålsrotation' notis för varje föremålsspawn"
LANG["PHXM_ADMIN_CAMERA_COLLIDE"]			= "Låt Föremålskamera kollidera med väggar"
LANG["PHXM_ADMIN_FREEZECAM"]				= "Slå på kamerafrysningsfunktioner för föremålslaget"
LANG["PHXM_ADMIN_FREEZECAM_HUNTER"]			= "Slå på kamerafrysningsfunktioner för jägarlaget"
LANG["PHXM_ADMIN_PROP_COLLIDE"]				= "Låt föremål kollidera med andra föremålsspelare"
LANG["PHXM_ADMIN_SWAP_TEAM"] 				= "Byt lag varje runda - lagen förblir på varsin sida om denna är av."
LANG["PHXM_ADMIN_HUNTER_PENALTY"]			= "Hälsostraff för jägare"
LANG["PHXM_ADMIN_HUNTER_KILL_BONUS"]		= "Jägardråpsbonus"
LANG["PHXM_ADMIN_HUNTER_SMG_GRENADES"]		= "SMG granater till jägarna"
LANG["PHXM_ADMIN_GAME_TIME"]				= "(Kräver omstart av kartan) Total speltid (minuter)"
LANG["PHXM_ADMIN_BLINDLOCK_TIME"]			= "Jägares blindtid (sekunder)"
LANG["PHXM_ADMIN_ROUND_TIME"]				= "(Kräver omstart av kartan) Omgångstid (sekunder)"
LANG["PHXM_ADMIN_ROUNDS_PER_MAP"]			= "(Kräver omstart av kartan) Totalt antal rundor per karta"
LANG["PHXM_ADMIN_ENABLE_LUCKYBALL"]			= "Tillåt Lyckobollar att spawna på förstörbara objekt (Chans är 8%)"
LANG["PHXM_ADMIN_ENABLE_CRYSTAL"]			= "Tillåt Djävulsbollar att spawna när jägare dör (Alltid)"
LANG["PHXM_ADMIN_WAIT_PLAYERS"]				= "Vänta på spelare att påbörja spelet"
LANG["PHXM_ADMIN_WAIT_MIN_PLAYERS"]			= "Minsta antal spelare att vänta på innan spelet börjar (standard: 1)"
LANG["PHXM_ENABLE_PLAYER_JOIN_LEAVE"] 		= "Slå på chat notis för anslutning samt avgång av spelare? Sätt denna på 0 om du föredrar att använda ditt egna chattillägg."

LANG["PHXM_ADMIN_FORCEJOINBALANCE"]			= "Tvinga spelare att jämna ut lagen när de ansluter (stäng av detta om lagrotation är PÅ)"
LANG["PHXM_ADMIN_ENABLETEAMBALANCE"]		= "Slå på lagutjämning: Jämna ut lagen automatiskt i början av varje runda."
LANG["PHXM_ADMIN_PICKUP_PROPS"] 			= "Tillåt upplockning av små objekt? 0: Tillåt inte, 1: Endast jägare, 2: Endast föremål, 3: Tillåt alla."

LANG["PHXM_ADMIN_TAUNTMODES"]			= "Hånlägen"
LANG["PHXM_ADMIN_TAUNTMODE_MODE"]		= "--[Nuvarande hånläge är: %d ]--"
LANG["PHXM_ADMIN_TAUNTMODE0"]			= "Läge [0]: F3/Slumpmässigt hån"
LANG["PHXM_ADMIN_TAUNTMODE1"]			= "Läge [1]: C/Anpassat hån"
LANG["PHXM_ADMIN_TAUNTMODE2"]			= "Läge [2]: Båda lägen"
LANG["PHXM_ADMIN_TAUNTSOPEN"]			= "Öppna hånfönster"

LANG["PHXM_MODE_DEFAULT"] 				= "--[ Nuvarande upplockningsläge är %d ]--"
LANG["PHXM_MODE0"]						= "Läge [0]: Tillåt inte"
LANG["PHXM_MODE1"]						= "Läge [1]: Endast jägare"
LANG["PHXM_MODE2"]						= "Läge [2]: Endast föremål"
LANG["PHXM_MODE3"]						= "Läge [3]: Tillåt alla"

--[[
	Admin Developer Sections
]]
LANG["PHXM_ADMIN_DEVSECTION"]		= "Inställningar för utvecklare"
LANG["PHXM_ADMIN_ROOMCHECK"]		= "Slå på gränskontroller? Detta förhindrar att du fastnar i väggar/objekt."
LANG["PHXM_ADMIN_USENEWMKBREN"]		= "Använd ny modell för bonusvapnet Bren MK II (Kräver omstart av kartan)"
LANG["PHXM_ADMIN_BEVERBOSE"]		= "Utvecklare: Var ordrik - låt PH:X skriva ut all information och alla händelser utförligt?"
LANG["PHXM_ADMIN_SHOWPLNAMEHEAD"]	= "Låt spelarens lagnamn visas på deras skärm."
LANG["PHXM_ADMIN_USESINGLE_FZCAM"]	= "Använd ett fryskameraljud isället för ljudlista (Använd 'ph_fc_cue_path' för att ställa in sökvägen till fryskamerans ljud)"
LANG["PHXM_ADMIN_MODELLISTINGTYPE"] = "Metod för att lista modeller: 0: Inkludera allt, 1: Använd list.Get('PlayerOptionsModel')"
LANG["PHXM_ADMIN_JUMPPOWER"]		= "Ytterligare hoppkraft för föremål"
LANG["PHXM_ADMIN_ENABLE_OBB"]		= "Utvecklare: Slå på anpassad modifierare till föremålsentiteters modellgränser (OBB) från konfigurationsdata"
LANG["PHXM_ADMIN_RELOAD_OBB"]		= "Utvecklare: ladda om data för OBB modifierare varje runda"
